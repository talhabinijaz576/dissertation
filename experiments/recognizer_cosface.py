...
class CosfaceRecognizer(BasicRecognizer):
    
    algorithm = "CosFace101"
    ...
    def __init__(self, face_detector, landmark_detector, dataset, tolerance = 0.6):
        ...
        model_file = "models/cosface101.h5"
...
# recognizer = CosfaceRecognizer(face_detector, landmark_detector, None, tolerance=1.24)
...
#         success = is_matching == verification.verified
#         l.append(success)
#         print(success, verification.verified, verification.min_distance, verification.time_taken)
#         #verification.show()
#     except:
#         continue
# print(np.mean(l))
